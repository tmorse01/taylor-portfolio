  ...
  return (
    <div className="grid items-start gap-8 mx-auto sm:max-w-4xl sm:grid-cols-2 md:gap-12 lg:max-w-5xl lg:grid-cols-3">
      ...
      <div className="grid gap-1">
        ...
        <p className="text-sm">
          Skilled in enhancing JavaScript with strong typing using TypeScript.
        </p>
      </div>
      <div className="grid gap-1">
      ...
      <div className="grid gap-1">
        ...
        <p className="text-sm">
          Proficient in using .NET Entity Framework for efficient data modeling
      ...
      <div className="grid gap-1">
        ...
        <p className="text-sm">
          Skilled in creating reliable and high-performance applications with
          Java.
        </p>
      </div>
      <div className="grid gap-1">
        ...
        <p className="text-sm">
          Versatile in writing efficient Python code for a variety of projects.
        </p>
      </div>
      <div className="grid gap-1">
      ...
      <div className="grid gap-1">
        ...
        <p className="text-sm">
          Skilled in deploying and managing applications on Azure and AWS cloud
          platforms.
        </p>
      </div>
      <div className="grid gap-1">
